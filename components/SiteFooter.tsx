...
const groups = [
  { title: 'Build', links: [['Draft teams', '/draft'], ['Bingo hall', '/bingo'], ['Community boards', '/templates'], ['Task library', '/presets'], ['RuneLite beta', '/runelite']] },
    ...
    <footer className="border-t border-[#9b792f]/45 bg-[#100d09] text-[#b9ab88]">
      <div className="mx-auto grid max-w-7xl gap-8 px-5 py-10 sm:px-8 md:grid-cols-[1.35fr_repeat(3,1fr)]">
        <div>
          ...
          <p className="mt-3 max-w-sm text-xs leading-relaxed">Make fair clan teams, build custom bingo boards, and run the whole event from one great hall.</p>
