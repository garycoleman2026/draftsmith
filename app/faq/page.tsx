...
const questions = [
  ...
  ['Can I make a custom OSRS bingo?', 'Yes. Open the Bingo page, enter the event details and teams, then select “Customize board before launch.” Boards can be 3 × 3 through 7 × 7 with classic, points, lockout, blackout, progression, or category scoring. Every tile can have exact rules, item or boss artwork, notes, exclusions, proof sources, and editable time assumptions.'],
