...
export default function TermsPage() {
  return <ContentPage eyebrow="Terms of use" title="Use the hall fairly." intro="Effective August 27, 2026. By using the hosted beta, you agree to these practical rules and acknowledge its current limitations.">
    ...
    <p>You retain responsibility for event names, surveys, task text, claim notes, links, evidence, public clan descriptions, and community boards you submit. You grant the service permission to store, process, and display that material only as needed to operate the event and its selected public views. Do not submit content you lack permission to use. Public listings or votes may be limited or removed when they are deceptive, abusive, infringing, unsafe, or manipulated.</p>
